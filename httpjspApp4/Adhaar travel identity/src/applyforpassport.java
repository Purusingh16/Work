...
public class applyforpassport extends HttpServlet 
{
	Connection con;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			pw.println("<body bgcolor='cyan'>");
				...
				pw.println("Are you working in central Government/State Govt/PSU/Statutory bodies:<input type='radio' value='yes' name='radio22'>yes <input type='radio' value='no' name='radio22'>no<br/>");
                                         
				pw.println("If you have ever returned to india on Emergency Certificate or were ever deported or repatriated at govt cost then,EC No.,date and place of issue and attach seizure in original,place and country where deported/repartriated<textarea name='t4'></textarea><br/>");
